...
class CrossEncoderDataset(data.Dataset):
    def __init__(self, data_path,
        ...
        if should_load_definition:
            ...
            if self.full_doc:
                with open(f'/cs/labs/tomhope/forer11/SciCo_Retrivel/definition_handler/data/gpt_3.5_definitions/def_files/{data_label}_terms_definitions_final.pickle', "rb") as fp:
