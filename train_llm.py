...
new_model = "Mistral-7B-v0.2-hf-scico-no-def"
...
train_prompts = [{'text': get_format_prompt(data.train_dataset.pairs[i], data.train_dataset.natural_labels[i])} for i in range(len(data.train_dataset))]
